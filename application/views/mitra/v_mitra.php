        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addMitra()"><i class="fa fa-plus"></i> | Tambah Mitra</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                        ...
                        <input type="text" name="nama_mitra" id="" placeholder="Nama Mitra" class="form-control" >
                        <p class="help-block mb-0"></p>
                    </div>
										<div class="form-group">
                        <label for="">Kontak Mitra</label>
                        <input type="text" name="kontak_mitra" id="" placeholder="Kontak Mitra" class="form-control" >
                        <p class="help-block mb-0"></p>
                    </div>
										<div class="form-group">
                        <label for="">Email Mitra</label>
                        <input type="text" name="email_mitra" id="" placeholder="Email Mitra" class="form-control" >
                        <p class="help-block mb-0"></p>
                    </div>
										<div class="form-group">
                        <label for="">Alamat Mitra</label>
                        <textarea type="text" name="alamat_mitra" rows="3" id="" placeholder="Alamat mitra" class="form-control" ></textarea>
                        <p class="help-block mb-0"></p>
                    </div>
										<div class="form-group">
