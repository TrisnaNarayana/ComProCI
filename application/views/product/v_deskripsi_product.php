...
<script type="text/javascript">
      ...
      $('#formJ').on('submit', function(e){
                ...
                var url;
                if(save_method == 'add'){
                    url = "<?=base_url().'Product/updateDeskripsi';?>";
                } else {
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                  	...
                  	<label class="">Description</label>
		                	<textarea name="deskripsi" id="editor" class="form-control" data-iconlibrary="fa" rows="10" required><?php echo htmlspecialchars(set_value('deskripsi'));?><?=$detail->desc_product?></textarea>
		                </div>
                </div>
