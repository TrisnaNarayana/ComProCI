        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addProduct()"><i class="fa fa-plus"></i> | Tambah Product</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                        ...
                        <input type="text" name="nama_product" id="" placeholder="Nama Product" class="form-control" >
