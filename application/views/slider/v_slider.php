        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
								<button class="btn btn-danger btn-sm pull-left" onclick="addSlider()"><i class="fa fa-plus"></i> | Tambah Slider</button>
...
<script type="text/javascript">
      ...
      $('#dropify').dropify({
                messages: {
                      default: 'Choose file PDF/DOC/DOCX/ZIP/RAR/APK max(2 MB)',
                      replace: 'Update',
                      remove:  'Remove',
                      error:   'error'
                  }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                        ...
                        <input type="text" name="nama_slider" id="" placeholder="Judul Slider" class="form-control" >
