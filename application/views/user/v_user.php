        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addUser()"><i class="fa fa-plus"></i> | Tambah User</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" id="" placeholder="Nama Lengkap" class="form-control" >
					...
					<div class="form-group">
                        ...
                        <input type="text" name="jabatan" id="" placeholder="Jabatan" class="form-control" >
                        <p class="help-block mb-0"></p>
                    </div>
                    <div class="form-group">
                        <label for="">Keahlian</label>
                        <textarea name="keahlian" id="editor" placeholder="Keahlian..." class="form-control" data-iconlibrary="fa" rows="10" required></textarea>
                        <p class="help-block mb-0"></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact" id="" placeholder="Kontak" class="form-control" >
                        <p class="help-block mb-0"></p>
                    </div>
