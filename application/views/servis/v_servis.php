        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addServis()"><i class="fa fa-plus"></i> | Tambah Servis</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script>
    ...
    $(document).ready(function () {
      table =  $('#tabel').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo base_url().'Servis/ajax_list'?>",
                        "type": "POST"
                    },
...
<script type="text/javascript">
      ...
      $('#formJ').on('submit', function(e){
                ...
                var url;
                if(save_method == 'add'){
                    url = "<?=base_url().'Servis/add';?>";
                } else {
                    url = "<?=base_url().'Servis/update';?>";
                }
           e.preventDefault();
                $.ajax({
                     url:url,
        ...
        function updateServis(id)
        {
            ...
            $.ajax({
                url : "<?=base_url().'Servis/get/'?>"+id,
                type : "GET",
                dataType : "JSON",
                success : function(data)
                {
                    $('[name="id"]').val(data.id_servis);
                    $('[name="nama_servis"]').val(data.nama_servis);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                        ...
                        <input type="text" name="nama_servis" id="" placeholder="Nama Servis" class="form-control" >
