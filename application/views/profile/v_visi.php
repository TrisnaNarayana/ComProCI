        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addProfile()"><i class="fa fa-pencil"></i> | Edit Visi dan Misi</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="form-group">
		                	...
		                	<textarea name="visi" id="editor" class="form-control" data-iconlibrary="fa" rows="10" required><?php echo htmlspecialchars(set_value('deskripsi'));?></textarea>
		                </div>
                        <div class="form-group">
                  	        <label class="">Misi</label>
		                	<textarea name="misi" id="editor1" class="form-control" data-iconlibrary="fa" rows="10" required><?php echo htmlspecialchars(set_value('deskripsi'));?></textarea>
		                </div>
                </div>
