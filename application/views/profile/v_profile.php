        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addProfile()"><i class="fa fa-pencil"></i> | Edit Profile</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <form class="form" id="formJ" action="#" method="post">
                  	...
                  	<label class="">Telepon</label>
						...
						<label class="">Jam Kerja</label>
							<input type="text" name="jam_kerja" placeholder="Jam Kerja" class="form-control">
						</div>
                </div>
